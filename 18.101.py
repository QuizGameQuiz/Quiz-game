...
round_4_questions = {"В каком возрасте дети получают письмо из хогвартса?": ['1. 12 ' '2. 11 ' '3. 14 ' '4. 10 '], "Из чего сделана палочка Гарри Поттера?": ['1. Жила дракона ' '2. Перо феникса ' '3. Остролист ' '4. Береза ']}
round_4_answers = {"В каком возрасте дети получают письмо из хогвартса?": 4, "Из чего сделана палочка Гарри Поттера?": 4}
